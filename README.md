![image](https://user-images.githubusercontent.com/31723044/111271317-61331c80-8674-11eb-8a6d-3ea398c230cb.png)
...
기능적 요구사항
1. 호스트(방주인)이 임대할 방을 등록한다.
2. 호스트(방주인)이 등록한 방의 내용을 수정/삭제 할 수 있다.
3. 고객이 방을 예약한다.
4. 예약과 동시에 결제가 이루어 진다.
5. 고객이 결제 완료 시 예약이 확정된다. 
6. 확정 시 고객에게 알림 메시지 및 호스트의 안내 사항이 전송된다.
7. 고객이 예약을 취소할 수 있다.
8. 사용 후 고객이 후기를 등록/수정/삭제할 수 있다.

비기능적 요구사항
1. 트랜잭션 - 결제가 되지 않은 주문건은 아예 거래가 성립되지 않아야 한다  Sync 호출 
