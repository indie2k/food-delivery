...
1. 호스트(방주인)이 임대할 방을 등록한다.
   호스타(방주인)이 등록한 방의 내용을 수정/삭제 할 수 있다.
2. 고객이 숙박하고자 하는 방을 조회한다.
3. 고객이 방을 예약한다. (예약과 동시에 결제가 이루어 진다.)
4. 고객이 결제 완료 시 예약이 확정된다. (확정 시 고객에게 알림 메시지 및 호스트의 안내 사항이 전송된다)
   고객이 예약을 취소할 수 있다.
5. 사용 후 고객이 후기를 등록/수정/삭제할 수 있다.
